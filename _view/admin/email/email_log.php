...
<?php if (!$oCollection):?>
	<p><?php echo __('No emails found')?></p>
<?php else:?>
	<!-- Box -->
	<div class="box">
		...
		<form id="searchAndFilters" method="get" action="<?php echo MVC_ACTION_URL?>" >
			<h2 class="left"><?php echo __('Emails list')?></h2>
			<div class="right">
				<label><?php echo __('Search for emails')?></label>
