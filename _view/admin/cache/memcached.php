...
<div id="main">
	...
	<div id="content">
		...
		<div class="box">
			...
			<!-- Box Head -->
			<div class="box-head">
				<h2 class="left">Memcache Stats</h2>
			</div>
			<!-- End Box Head -->
		...
		<div class="box">
			...
			<!-- Box Head -->
			<div class="box-head">
				<h2 class="left">Clear one Memcached key</h2>
			</div>
			<!-- End Box Head -->
			...
			<form id="memcacheFlush" action="<?php echo MVC_MODULE_URL?>/flush_memcached.html" method="post">
				...
				<div class="form">
					<p>
						<label>Flush one Memcached key <span>(Required Field)</span></label>
		...
		<div class="box">
			...
			<!-- Box Head -->
			<div class="box-head">
				<h2 class="left">Clear all Memcached keys</h2>
			</div>
			<!-- End Box Head -->
			...
			<form id="memcacheAllFlush" action="<?php echo MVC_MODULE_URL?>/flush_all_memcached.html" method="post">
				<!-- Form -->
				<div class="form">
					<p><label>Flush all Memcached keys ! </label></p>
				</div>
				<!-- End Form -->
