                ...
                <div class="contact-form">
                    ...
                    <form id="contact-form" class="contact-form row" name="contact-form" method="post">
                        <div class="form-group col-md-6">
                            <input type="text" id="name" name="name" class="form-control" placeholder="<?php echo __('Name')?>" value="<?php echo $FV->name?>">
                            <label id="path-error" class="error" for="path"><?php echo $FV->name_error?></label>
                        </div>
                        <div class="form-group col-md-6">
                            <input type="email" id="email" name="email" class="form-control" placeholder="<?php echo __('Email address')?>" value="<?php echo $FV->email?>">
                            <label id="path-error" class="error" for="path"><?php echo $FV->email_error?></label>
                        </div>
                        <div class="form-group col-md-12">
                            <input type="text" id="subject" name="subject" class="form-control" placeholder="<?php echo __('Subject')?>" value="<?php echo $FV->subject?>">
                        ...
                        <div class="form-group col-md-12">
                            <input type="submit" id="submit-form" name="submit" class="btn btn-primary pull-right" value="<?php echo __('Send')?>">
                        </div>
