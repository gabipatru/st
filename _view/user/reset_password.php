<div id="form-page">
    <div class="bg">
        <div class="row">
            <div class="col-sm-4">
                <h2 class="title text-center"><?php echo $this->__('Reset password')?></h2>
            </div>
        </div>
<?php if (!$error):?>
    <div class="row">  
...
<form id="reset_passwd" class="contact-form row" action="<?php echo MVC_ACTION_URL?>" method="post">
    ...
    <input type="hidden" name="token" value="<?php echo $this->__securityGetToken()?>" />
    <div class="form-group col-md-12">
        <input type="submit" class="btn btn-primary pull-right" value="<?php echo $this->__('Reset')?>" />
    </div>
