...
<form id="newUser" class="contact-form row" action="<?php echo MVC_ACTION_URL?>" method="post">
    <div class="form-group col-md-12">
        ...
        <input type="text" class="form-control" name="email" placeholder="<?php echo $this->__('Email address')?>" value="<?php echo $FV->email?>">
        <label id="email-error" class="error" for="email"><?php echo $FV->email_error?></label>
    </div>
    <div class="form-group col-md-12">
        <span><?php echo $this->__('Username')?>:</span>
        <input type="text" class="form-control" name="username" placeholder="<?php echo $this->__('Username')?>" value="<?php echo $FV->username?>">
    ...
    <div class="form-group col-md-12">
        ...
        <input type="text" class="form-control" name="first_name" placeholder="<?php echo $this->__('First Name')?>" value="<?php echo $FV->first_name?>">
    ...
    <div class="form-group col-md-12">
        ...
        <input type="text" class="form-control" name="last_name" placeholder="<?php echo $this->__('Last Name')?>" value="<?php echo $FV->last_name?>">
        <label id="last_name-error" class="error" for="last_name"><?php echo $FV->last_name_error?></label>
    </div>
    
    <div class="form-group col-md-12">
        <input type="submit" class="btn btn-primary pull-right" value="<?php echo $this->__('Create User')?>">
    </div>
