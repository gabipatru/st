    ...
    <div class="shell">
        ...
        <div id="navigation">
            <ul>
                ...
                <li><a href="<?php echo href_admin('categories/list')?>" class="<?php echo ($menu == 'categories' ? 'active' : '')?>"><span><?php echo __('Categories')?></span></a></li>
                ...
                <li><a href="<?php echo href_admin('email/list_menu')?>" class="<?php echo ($menu == 'email' ? 'active' : '')?>"><span><?php echo __('Email')?></span></a></li>
            </ul>
        </div>
        <!-- End Main Nav -->
    </div>
